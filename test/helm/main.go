...
var (
	...
	// File path constants
	artifactsPath     = filepath.Join(os.Getenv("WORKSPACE"), "test")
	chartsBasePath    = "./"
	whiteListYamlPath = filepath.Join(chartsBasePath, "test/helm/whitelist.yaml")
	helmPath          = "helm"
	kubectlPath       = "kubectl"
)
...
func doMain() int {
	...
	//uncomment if test results are required
